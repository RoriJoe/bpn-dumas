...
class Kakan_main extends CI_Controller {
	...
	public function _kakan_main_output($output = null)
	{
		$this->load->view('kakan_main.php',$output);
	}
/* 
	public function offices()
	{
		...
		$this->_kakan_main_output($output);
	}
 */
	public function index()
	{
		$this->_kakan_main_output((object)array('output' => '' , 'js_files' => array() , 'css_files' => array()));
	}
...
//add action
			$crud->add_action('Proses', '', 'Login','ui-icon-person',array($this,'send2PDU'));
	...
	function send2PDU($primary_key , $row)
	{
		return site_url('kirim_pdu').'?nomor_pengaduan='.$row->nomor_pengaduan;
...
/*
	...
	function multigrids()
	{
		...
		$this->_kakan_main_output((object)array(
				'js_files' => $js_files,
				'css_files' => $css_files,
				'output'	=> $output
		));
