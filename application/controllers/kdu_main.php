...
class Kdu_main extends CI_Controller {
	...
	public function _kdu_main_output($output = null)
	{
		$this->load->view('kdu_main.php',$output);
	}
/* 
	public function offices()
	{
		...
		$this->_kdu_main_output($output);
	}
 */
	public function index()
	{
		$this->_kdu_main_output((object)array('output' => '' , 'js_files' => array() , 'css_files' => array()));
	}
...
//add action
			$crud->add_action('Kirim SPK', '', 'Login','ui-icon-person',array($this,'send2SPK2'));
	...
	function send2SPK2($primary_key , $row)
	{
		return site_url('kirim_spk').'?nomor_pengaduan='.$row->nomor_pengaduan;
...
/*
	...
	function multigrids()
	{
		...
		$this->_kdu_main_output((object)array(
				'js_files' => $js_files,
				'css_files' => $css_files,
				'output'	=> $output
		));
