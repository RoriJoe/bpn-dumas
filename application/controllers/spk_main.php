...
class Spk_main extends CI_Controller {
	...
	public function _spk_main_output($output = null)
	{
		$this->load->view('spk_main.php',$output);
	}
/* 
	public function offices()
	{
		...
		$this->_spk_main_output($output);
	}
 */
	public function index()
	{
		$this->_spk_main_output((object)array('output' => '' , 'js_files' => array() , 'css_files' => array()));
	}
...
//add action
			$crud->add_action('Kirim Koord.', '', 'Login','ui-icon-person',array($this,'send2KDU'));
	...
	function send2KDU($primary_key , $row)
	{
		return site_url('kirim_kdu').'?nomor_pengaduan='.$row->nomor_pengaduan;
...
/*
	...
	function multigrids()
	{
		...
		$this->_spk_main_output((object)array(
				'js_files' => $js_files,
				'css_files' => $css_files,
				'output'	=> $output
		));
