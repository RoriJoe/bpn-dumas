...
<body>
<form name="konfirmasi" action="spk_main/entri_pengaduan">
	<table align="center">
		<tr>
			<td colspan="3" align="center"><h1>Form Kirim ke Koordinator Dumas</h1></td>
		</tr>
		<tr>
			...
			*/
			...
			$query = $this->db->query('update tbl_dumas_pengaduan set apl_status="KDU" where nomor_pengaduan='.$nomor_pengaduan);
			?></td>
		</tr>
		<tr>
			<td>Note </td>
