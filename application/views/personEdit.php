    ...
    <div class="content">
        ...
        <table>
            ...
            <tr>
                ...
                <?php echo $this->form_validation->name_error; ?></td>
            </tr>
            <tr>
                <td valign="top">Gender<span style="color:red;">*</span></td>
                <td><input type="radio" name="gender" value="M" <?php echo $this->form_validation->set_radio('gender', 'M'); ?>/> M
                    <input type="radio" name="gender" value="F" <?php echo $this->form_validation->set_radio('gender', 'F'); ?>/> F
                    <?php echo $this->form_validation->gender_error; ?></td>
            </tr>
            <tr>
                <td valign="top">Date of birth (dd-mm-yyyy)<span style="color:red;">*</span></td>
                <td><input type="text" name="dob" onclick="displayDatePicker('dob');" class="text" value="<?php echo $this->form_validation->dob; ?>"/>
                ...
                <?php echo $this->form_validation->dob_error; ?></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
